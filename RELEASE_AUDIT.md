...
- `release\BridgeClip-20260608-0335`
...
- `tools\verify_release.ps1` passed for `release\BridgeClip-20260608-0335`, including required artifact checks, SHA-256 verification, Windows zip content checks, and APK signature verification.
...
- `tools\verify_release.ps1 -RequireStoreSigning` is available to fail store-submission verification when the APK is still debug-signed.
