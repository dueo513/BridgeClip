...
- `release\BridgeClip-20260608-0358`
...
- `tools\verify_release.ps1` passed for `release\BridgeClip-20260608-0358`, including required artifact checks, SHA-256 verification, Windows zip content checks, manifest checks, and APK/AAB signature verification.
