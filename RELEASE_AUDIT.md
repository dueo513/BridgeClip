...
- `release\BridgeClip-20260608-0401`
...
- Release packages include `RELEASE_MANIFEST.json`, and `tools\verify_release.ps1` checks its release ID, paths, hashes, sizes, Android signing state, and store readiness.
