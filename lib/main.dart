...
class _ClipboardHomeState extends State<ClipboardHome>
      ...
      builder: (context, lang, child) {
        ...
        return Scaffold(
          ...
          drawer: AppDrawer(
            ...
            onConnectDevice: () => _openConnectDeviceFromDrawer(context),
            onSelectClipboard: () => _selectDrawerTab(context),
            onSelectArchive: () => _selectDrawerTab(context, archive: true),
            onSelectSettings: () => _selectDrawerTab(context, settings: true),
          ),
          body: _isSettingsTab
  ...
  void _openConnectDeviceFromDrawer(BuildContext context) {
    Navigator.pop(context);
